...
//
//     final getPhotosResponse = getPhotosResponseFromJson(jsonString);

import 'dart:convert';

GetPhotosResponse getPhotosResponseFromJson(String str) => GetPhotosResponse.fromJson(json.decode(str));

String getPhotosResponseToJson(GetPhotosResponse data) => json.encode(data.toJson());
...
class GetPhotosResponse {
  ...
  factory GetPhotosResponse.fromJson(Map<String, dynamic> json) => GetPhotosResponse(
